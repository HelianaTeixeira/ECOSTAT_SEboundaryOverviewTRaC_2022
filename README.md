...
            •           ICType.csv (input file) – correspondence between Intercalibration Type code and description
...
            •           2_TRACrevised_Summary.Rmd (produces Chapters 1 and 2 tables as well as other overview tables summarising tables)
...
            •           chp4 subfolder: where outputs (single word files .docx) of each SE are stored to be merged into a single chp4_ecostat2014-WFDreporting.docx
