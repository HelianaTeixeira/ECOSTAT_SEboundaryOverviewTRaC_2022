...
#Select standard
    #drop RO All.obs == 5797
dat.u <- dat.TW %>% 
  filter(physChemText==physChemText.u,!is.na(ValueStd),All.obs!=5797) %>% 
...
```{r, fig.width = 7, fig.height =6, fig.cap=FCapA1, warning = FALSE}
...
```{r, fig.width = 7, fig.height =6, fig.cap=FCapA2, warning = FALSE}
